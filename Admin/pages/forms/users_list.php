<?php
  ...
  if(isset($_GET['type']) && $_GET['type']='delete')
  {
    ...
    $data->deleteData('users',$condition_arr);
    echo("<script>alert('successfully Delete a Record')</script");
  }
  $result = $data->getData('registration','*');
?> 
<!DOCTYPE html>
<html lang="en">
<head>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    if(isset($result['0']))
                    {
                     foreach ($result as $value)
                     {
                            ...
                            ?><td><a href=""><i style="font-size:24px" class="fa">&#xf044;</i></a></td>
                              <td><a href=""><i style="font-size:24px" class="fa">&#xf06e;</i></a></td>
                              <td><a href="?type=delete&id=<?php echo $value['id']?>"><i style='font-size:24px' class='fa'>&#xf2ed;</i></a></td>
                              </tr>
                          <?php   
                          $sn++;  
                    }
                    ...
                    {
                      echo "<td colspan='9' align='center'>No Records Found </td>";
                    }               
                  ?>
                  <!-- Query -->
                  </tbody>
