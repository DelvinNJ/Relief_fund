<?php
 ...
 {  
  ...
  {  
      ...
      if($data->insert('bank', $insert_data))  
      {  
          move_uploaded_file($_FILES['passbook']['tmp_name'], $target);
          echo '<script type="text/javascript">'; 
          echo 'alert("Successfully Add Bank Details");'; 
        ...
        <div class="col-md-10 col-sm-12 col-form">
          ...
          <form method="post" enctype="multipart/form-data" name="bankform" id="bankform">
              ...
              <div class="row">
                            ...
                            <input type="password" name="accnum" id="accnum" class="form-control" value="" placeholder="Account Number*" maxlength="25"  autofocus>
                            ...
                            <input type="text" name="c_accnum" id="c_accnum" class="form-control" value="" placeholder="Account Number*" maxlength="25"  autofocus>
              ...
              <div class="row">
                             <div class="form-group col-md-6">
                                ...
                                <input type="password" name="ifsc" id="ifsc" class="form-control" value="" placeholder="IFSC Code*" maxlength="25">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Confirm IFSC code</label>
                                <input type="text" name="c_ifsc" id="c_ifsc" class="form-control" value="" placeholder="IFSC Code*" maxlength="25">
                            </div>
              ...
              <div class="row">
                            ...
                            <input type="text" name="bank" id="bank" class="form-control" value="" placeholder="Name of Bank*" maxlength="30">
                            </div>
