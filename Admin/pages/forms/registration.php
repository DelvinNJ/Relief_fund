              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <!-- Query -->
                    <?php
                      $result = $data->getData('registration','*','','status','asc');
                      $sn=1;
                      if(isset($result['0']))
                      {
                        foreach ($result as $value)
                        {
                          ...
                          echo "<td>" . $value['aadhaar'] . "</td>";
                          echo "<td>" . $value['pancard'] . "</td>";
                          ?>
                            <td><a onclick="return confirm('Are You sure that You want to delete this?')" href="delete.php?id=<?php echo $value['id']?>&table=registration"><i style='font-size:24px' class='fa'>&#xf2ed;</i></a></td>
