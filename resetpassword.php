...
if(isset($_POST["submit"]))
{
    ...
    $condition_arr = array(
                        ...
                        'password'=>md5(mysqli_real_escape_string($data->con, $_POST['curpassword'])),
                      );
...
<html class="no-js">
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">RESET PASSWORD !<span class="title-under"></span></h1>
					...
					<form method="POST" action="" name="vform" id="vform">
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
	                         ...
	                         <div class="form-group col-md-12">
	                            <input type="password" name="curpassword" id="curpassword" class="form-control" placeholder="Current Password" required>
	                        </div>
