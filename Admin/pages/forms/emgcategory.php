<?php
  ...
  // Insert
   ...
   {  
        ...
        if($data->insert('emgcategory', $insert_data))  
        {  
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="" name="emgcategoryform" id="emgcategoryform">
                <div class="card-body">
                  <div class="col-6">
                    ...
                    <?php
                      ...
                      if(isset($result['0']))
                      {
                        foreach ($result as $value)
                        {
                          ...
                          ?>
                          <td><a href="editemgcategory.php?id=<?php echo $value['id'];?>"><i style="font-size:24px" class="fa">&#xf044;</i></a></td>
                          <!-- <td><a href=""><i style="font-size:24px" class="fa">&#xf06e;</i></a></td> -->
                          <td><a onclick="return confirm('Are You sure that You want to delete this?')" href="delete.php?id=<?php echo $value['id']?>&table=emgcategory"><i style='font-size:24px' class='fa'>&#xf2ed;</i></a></td></tr>
