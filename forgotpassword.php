...
if(isset($_POST["submit"]))
{
    ...
    if($result>0)
    {
        ...
        $id = $result[0]['id'];
        $update_arr = array('password'=>md5(mysqli_real_escape_string($data->con, $_POST['password'])));
        $data->updateData('registration',$update_arr,$id);


        echo '<script type="text/javascript">'; 
        echo 'alert("Successfully Reset Password");'; 
    ...
    {
        echo "<script>alert('Email and Phone Number Does not Match')</script>";
    }
...
<html class="no-js">
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li><a class="is-active"  href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJvlqGggtDGlMLTdpRccQNccmbLFGkrFXHlldZNCspQrZFqNblprsBbfKCCdtVbNqNsNbTL">CONTACT</a></li>
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">FORGOT PASSWORD !<span class="title-under"></span></h1>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-7 col-sm-12 col-form">
					...
					<h2 class="title-style-2">FORGOT PASSWORD ! <span class="title-under"></span></h2>

					<form method="POST" action="" name="vform" id="vform">
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
	                         ...
	                         <div class="form-group col-md-12">
	                            <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone Number" required maxlength="10">
	                        </div>
                        ...
                        <div class="form-group alerts">
                         ...
                         <div class="form-group">
                            <button type="submit" class="btn btn-primary pull-right" name="submit">Send message</button>
                        </div>
