                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <ul class="list-unstyled list-inline header-contact">
                            <li> <i class="fa fa-phone"></i> <a href="tel:">+212 658 986 213 </a> </li>
                             <li> <i class="fa fa-envelope"></i> <a href="mailto:contact@sadaka.org">contact@sadaka.org</a> </li>                       </ul> <!-- /.header-contact  -->
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="has-child"><a href="">APPLICATION</a>

                      <ul class="submenu">
                         <li></li>
                         <li class="submenu-item"><a href="application.php"><i class="fa fa-edit" style="font-size:100%"></i> Add</a>
                    ...
                    <li class="has-child"><a href=""><?php echo $user[0]['fname'] . " " . $user[0]['lname']; ?></a>
                      ...
                      <ul class="submenu">
                         <li></li>
                         <li class="submenu-item"><a href="checkprofile.php"><i class="fa fa-user" style="font-size:100%"></i> Profile</a>
                        <li class="submenu-item"><a href="bank.php"><i class="fa fa-bank" style="font-size:100%"></i> Bank Details</a>
