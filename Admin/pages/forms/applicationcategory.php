<?php
  ...
  if(isset($_POST["submit"]))
  {
    print_r("Hello");
    extract($_POST); 
    $query = "INSERT INTO applicationcategory (category) values ('$category')";
    print_r($query);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Application Category Form</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form method="post">
                <div class="card-body">
                  <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Category Name" name="category" required>
                  </div>
